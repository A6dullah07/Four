  ...
  return (
    <div className="min-h-screen" style={{ background: "#111318" }}>
      <div className="px-5 pt-12 pb-5" style={{ background: "linear-gradient(135deg,#1e3a8a,#7c3aed)" }}>
        ...
        <p className="text-blue-200 text-xs mt-0.5">حلّل وضعك المالي بالذكاء الاصطناعي</p>
      </div>
      <div className="flex flex-col items-center justify-center py-20 text-center px-8">
        ...
        <p className="text-white font-bold mb-2">تحليل القوائم المالية</p>
        <p className="text-slate-500 text-sm">سيتم بناء التحليل المالي هنا قريباً</p>
      </div>
    </div>
  );
}