...
⚠️ قواعد صارمة لا تُخالَف عند تحليل الإيضاحات:
- **التوثيق الإلزامي:** لكل معلومة يجب إرفاق مصدرها: (إيضاح رقم X، ص Y، اسم التقرير والسنة).
- **دقة الأرقام:** اذكر الأرقام بالضبط كما وردت مع العملة والحجم (مثال: 14.5 مليون ريال سعودي، لا 14 مليون).
- **دقة التواريخ:** اربط كل التزام بتاريخه الدقيق (يوم/شهر/سنة إن وُجد). مثال: يستحق السداد في 31 ديسمبر 2025.
- **دقة الكميات:** وضّح أعداد الأسهم، القضايا، نسب الملكية، العقارات المرهونة بدقة متناهية.
- **Zero Hallucination:** إذا غابت تفاصيل، اكتب صراحةً: "هذه التفاصيل غير مذكورة صراحة في إيضاحات التقرير المرفق".

هيكل تحليل الإيضاحات:

**أ) نظرة عامة**
اسم الشركة | الفترة المالية | إجمالي عدد الإيضاحات الواردة في التقرير.

**ب) تفكيك الإيضاحات الجوهرية**
لكل إيضاح مؤثر:
| الإيضاح (رقم + صفحة) | ما يعنيه فعلاً | الأثر المالي الدقيق | تقييم المخاطر |
|----------------------|----------------|---------------------|----------------|
(🔴 عالية / 🟡 متوسطة / 🟢 منخفضة)

ركّز بالأولوية على:
1. الالتزامات المحتملة (Contingencies) — التقاضي والقضايا مع تواريخها وقيمها الدقيقة.
2. تعاملات الأطراف ذات العلاقة (Related Parties) — الأطراف، المبالغ، طبيعة العلاقة.
3. القروض وهيكلة الديون — تواريخ الاستحقاق، أسعار الفائدة، الضمانات.
4. الالتزامات خارج الميزانية (Off-Balance Sheet).
5. السياسات المحاسبية الجديدة أو المتغيرة.

**ج) الخلاصة الرقمية**
جدول يلخص: البند | القيمة الدقيقة | التاريخ | المصدر (إيضاح + صفحة).

**⚠️ Red Flags & تنبيهات المستثمر**
نقاط المراقبة الحرجة موثّقة بمصادرها.

**✅ الفرص والمحفزات الإيجابية**
عوامل النمو موثّقة بمصادرها.

**💡 توصية مختصرة**
جملة واحدة: نظرة المحلل بناءً على التحليل الموثّق فقط.
